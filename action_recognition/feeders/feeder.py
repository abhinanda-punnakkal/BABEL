...
class Feeder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        seg_id = self.sample_name[index]
        label = self.label[0][index]
        sid = self.label[1][index]
        chunk_n = self.label[2][index]
        anntr_id = self.label[3][index]
        ...
        return data_numpy, label, sid, seg_id, chunk_n, anntr_id, index
